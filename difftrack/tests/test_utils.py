...
def test_squash_diffs_no_squash():
	diffs = [
		(difftrack.ListDiff.INSERT, 1, {'order_count': 3, 'price': '41.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.REPLACE, 1, {'order_count': 1, 'price': '41.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.DELETE, 1, None)
	]
	...
	out_diffs = [
		difftrack.SquashResults(difftrack.ListDiff.INSERT, 1, 1, [
...
def test_squash_diffs_insert():
	diffs = [
		...
		(difftrack.ListDiff.INSERT, 2, {'order_count': 4, 'price': '35.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.INSERT, 3, {'order_count': 5, 'price': '50.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.REPLACE, 1, {'order_count': 1, 'price': '41.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
...
def test_squash_diffs_mixed_insert_with_space():
	diffs = [
		...
		(difftrack.ListDiff.INSERT, 4, {'order_count': 5, 'price': '50.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.REPLACE, 1, {'order_count': 1, 'price': '41.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
...
def test_squash_diffs_mixed_insert_wrong_ordering():
	diffs = [
		...
		(difftrack.ListDiff.INSERT, 1, {'order_count': 4, 'price': '35.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.INSERT, 3, {'order_count': 5, 'price': '50.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
	...
	out_diffs = [
		...
		difftrack.SquashResults(difftrack.ListDiff.INSERT, 3, 3, [
			{'order_count': 5, 'price': '50.345', 'orders': [{'paired_order': None, 'quantity': 372, 'id': '80021'}]}
		]),
		difftrack.SquashResults(difftrack.ListDiff.REPLACE, 1, 2, [
			{'order_count': 1, 'price': '41.345', 'orders': [{'paired_order': None, 'quantity': 372, 'id': '80021'}]}
...
def test_squash_diffs_replace():
	diffs = [
		...
		(difftrack.ListDiff.REPLACE, 2, {'order_count': 4, 'price': '35.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.REPLACE, 3, {'order_count': 1, 'price': '41.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.REPLACE, 4, {'order_count': 1, 'price': '41.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.REPLACE, 5, {'order_count': 5, 'price': '50.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.DELETE, 1, None)
	]
...
def test_squash_diffs_mixed_replace_with_space():
	diffs = [
		...
		(difftrack.ListDiff.REPLACE, 5, {'order_count': 1, 'price': '41.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.REPLACE, 6, {'order_count': 5, 'price': '50.345', 'orders': [
			{'paired_order': None, 'quantity': 372, 'id': '80021'}
		]}),
		(difftrack.ListDiff.DELETE, 1, None)
	]
...
def test_squash_diffs_general_data():
	...
	out_diffs = [
		difftrack.SquashResults(difftrack.ListDiff.INSERT, 1, 1, ['AAA', 'BBB', 'CCC']),
